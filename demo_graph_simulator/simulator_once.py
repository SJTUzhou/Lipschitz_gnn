...
def generator(class_0,class_1,A,mu0,mu1,cov):
...
def generate_dataset(class_0,class_1,A,mu0,mu1,cov,size):
    Attributes = []
    Labels = []

    for i in range(size):
        attributes,labels, _,_ = generator(class_0,class_1,A,mu0,mu1,cov)
...
if __name__ == "__main__":
    ...
    attributes, labels, class_0, class_1 = generator(class_0,class_1,A,mu0,mu1,cov)
    draw_colored_graph(A, class_0, class_1)
    draw_3d_scatter(attributes, list(class_0), list(class_1))

    Attributes, Labels = generate_dataset(class_0,class_1,A,mu0,mu1,cov,100)
